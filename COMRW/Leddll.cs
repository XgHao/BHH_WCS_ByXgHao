...
namespace COMRW
{
    public class Leddll
    {
        ...
        private static extern int LV_CreateProgram(int LedWidth, int LedHeight, int ColorType);
        public static int CreateProgram(int LedWidth, int LedHeight, int ColorType) => LV_CreateProgram(LedWidth, LedHeight, ColorType);
        ...
        private static extern int LV_AddProgram(int hProgram, int ProgramNo, int ProgramTime, int LoopCount);
        public static int AddProgram(int hProgram, int ProgramNo, int ProgramTime, int LoopCount) => LV_AddProgram(hProgram, ProgramNo, ProgramTime, LoopCount);
        ...
        private static extern int LV_SetProgramTime(int hProgram, int ProgramNo, ref PROGRAMTIME pProgramTime);
        public static int SetProgramTime(int hProgram, int ProgramNo, ref PROGRAMTIME pProgramTime) => LV_SetProgramTime(hProgram, ProgramNo, ref pProgramTime);
        ...
        ********************************************************************************************/
        ...
        private static extern int LV_AddImageTextArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, int IsBackgroundArea);
        public static int AddImageTextArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, int IsBackgroundArea) => LV_AddImageTextArea(hProgram, ProgramNo, AreaNo, ref pAreaRect, IsBackgroundArea);
        ...
        private static extern int LV_AddFileToImageTextArea(int hProgram, int ProgramNo, int AreaNo, string FilePath, ref PLAYPROP pPlayProp);
        ...
        private static extern int LV_AddSingleLineTextToImageTextArea(int hProgram, int ProgramNo, int AreaNo, int AddType, string AddStr, ref FONTPROP pFontProp, ref PLAYPROP pPlayProp);
        public static int AddSingleLineTextToImageTextArea(int hProgram, int ProgramNo, int AreaNo, int AddType, string AddStr, ref FONTPROP pFontProp, ref PLAYPROP pPlayProp) => LV_AddSingleLineTextToImageTextArea(hProgram, ProgramNo, AreaNo, AddType, AddStr, ref pFontProp, ref pPlayProp);
        ...
        private static extern int LV_AddMultiLineTextToImageTextArea(int hProgram, int ProgramNo, int AreaNo, int AddType, string AddStr, ref FONTPROP pFontProp, ref PLAYPROP pPlayProp, int nAlignment, int IsVCenter);
        public static int AddMultiLineTextToImageTextArea(int hProgram, int ProgramNo, int AreaNo, int AddType, string AddStr, ref FONTPROP pFontProp, ref PLAYPROP pPlayProp, int nAlignment, int IsVCenter) => LV_AddMultiLineTextToImageTextArea(hProgram, ProgramNo, AreaNo, AddType, AddStr, ref pFontProp, ref pPlayProp, nAlignment, IsVCenter);
        ...
        private static extern int LV_AddStaticTextToImageTextArea(int hProgram, int ProgramNo, int AreaNo, int AddType, string AddStr, ref FONTPROP pFontProp, int DelayTime, int nAlignment, int IsVCenter);
        public static int AddStaticTextToImageTextArea(int hProgram, int ProgramNo, int AreaNo, int AddType, string AddStr, ref FONTPROP pFontProp, int DelayTime, int nAlignment, int IsVCenter) => LV_AddStaticTextToImageTextArea(hProgram, ProgramNo, AreaNo, AddType, AddStr, ref pFontProp, DelayTime, nAlignment, IsVCenter);
        ...
        private static extern int LV_QuickAddSingleLineTextArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, int AddType, string AddStr, ref FONTPROP pFontProp, int nSpeed);
        public static int QuickAddSingleLineTextArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, int AddType, string AddStr, ref FONTPROP pFontProp, int nSpeed) => LV_QuickAddSingleLineTextArea(hProgram, ProgramNo, AreaNo, ref pAreaRect, AddType, AddStr, ref pFontProp, nSpeed);
        ...
        private static extern int LV_AddDigitalClockArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref DIGITALCLOCKAREAINFO pDigitalClockAreaInfo);
        public static int AddDigitalClockArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref DIGITALCLOCKAREAINFO pDigitalClockAreaInfo) => LV_AddDigitalClockArea(hProgram, ProgramNo, AreaNo, ref pAreaRect, ref pDigitalClockAreaInfo);
        ...
        private static extern int LV_AddTimeArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref TIMEAREAINFO pTimeAreaInfo);
        public static int AddTimeArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref TIMEAREAINFO pTimeAreaInfo) => LV_AddTimeArea(hProgram, ProgramNo, AreaNo, ref pAreaRect, ref pTimeAreaInfo);
        ...
        private static extern int LV_AddClockArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref CLOCKAREAINFO pClockAreaInfo);
        public static int AddClockArea(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref CLOCKAREAINFO pClockAreaInfo) => LV_AddClockArea(hProgram, ProgramNo, AreaNo, ref pAreaRect, ref pClockAreaInfo);
        ...
        private static extern int LV_AddWaterBorder(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref WATERBORDERINFO pWaterBorderInfo);
        public static int AddWaterBorder(int hProgram, int ProgramNo, int AreaNo, ref AREARECT pAreaRect, ref WATERBORDERINFO pWaterBorderInfo) => LV_AddWaterBorder(hProgram, ProgramNo, AreaNo, ref pAreaRect, ref pWaterBorderInfo);
        ...
        private static extern void LV_DeleteProgram(int hProgram);
        public static void DeleteProgram(int hProgram) => LV_DeleteProgram(hProgram);
        ...
        private static extern int LV_Send(ref COMMUNICATIONINFO pCommunicationInfo, int hProgram);
        ...
        private static extern int LV_TestOnline(ref COMMUNICATIONINFO pCommunicationInfo);
        ...
        private static extern int LV_SetOEDA(ref COMMUNICATIONINFO pCommunicationInfo, int Oe, int Da);
        ...
        private static extern int LV_AdjustTime(ref COMMUNICATIONINFO pCommunicationInfo);
        ...
        private static extern int LV_PowerOnOff(ref COMMUNICATIONINFO pCommunicationInfo, int OnOff);
        ...
        private static extern int LV_TimePowerOnOff(ref COMMUNICATIONINFO pCommunicationInfo, ref ONOFFTIMEINFO pTimeInfo);
        public static int TimePowerOnOff(ref COMMUNICATIONINFO pCommunicationInfo, ref ONOFFTIMEINFO pTimeInfo) => LV_TimePowerOnOff(ref pCommunicationInfo, ref pTimeInfo);
        ...
        private static extern int LV_SetBrightness(ref COMMUNICATIONINFO pCommunicationInfo, int BrightnessValue);
        ...
        private static extern int LV_TimeBrightness(ref COMMUNICATIONINFO pCommunicationInfo, ref BRIGHTNESSTIMEINFO pBrightnessTimeInfo);
        public static int TimeBrightness(ref COMMUNICATIONINFO pCommunicationInfo, ref BRIGHTNESSTIMEINFO pBrightnessTimeInfo) => LV_TimeBrightness(ref pCommunicationInfo, ref pBrightnessTimeInfo);
        ...
        private static extern int LV_SetLanguage(ref COMMUNICATIONINFO pCommunicationInfo, int LanguageValue);
        ...
        private static extern int LV_LedTest(ref COMMUNICATIONINFO pCommunicationInfo, int TestValue);
        ...
        private static extern int LV_TimeLocker(ref COMMUNICATIONINFO pCommunicationInfo, int LockerYear, int LockerMonth, int LockerDay, int LockerHour, int LockerMinute);
        ...
        private static extern int LV_CancelLocker(ref COMMUNICATIONINFO pCommunicationInfo);
        ...
        private static extern int LV_SetLedCommunicationParameter(ref COMMUNICATIONINFO pCommunicationInfo, ref LEDCOMMUNICATIONPARAMETER pLedCommunicationParameter);
        public static int SetLedCommunicationParameter(ref COMMUNICATIONINFO pCommunicationInfo, ref LEDCOMMUNICATIONPARAMETER pLedCommunicationParameter) => LV_SetLedCommunicationParameter(ref pCommunicationInfo, ref pLedCommunicationParameter);
